...
class TransactionController extends Controller
{
    ...
    public function show($id)
    {
        ...
        // // class show membutuhkan relasi dengan details dan product. Details adalah class dari model Transaction, product adalah class dari Model TransactionDetail.
        // dd($item);
